...
mods.extendedcrafting.TableCrafting.addShaped("dank_7", <item:dankstorage:dank_7>, [
	...
	[<item:extendedcrafting:flux_star>, <item:extendedcrafting:ender_star>, <item:extendedcrafting:nether_star_block>, <item:cyclic:soulstone>, <item:extendedcrafting:the_ultimate_ingot>, <item:cyclic:soulstone>, <item:extendedcrafting:nether_star_block>, <item:extendedcrafting:ender_star>, <item:extendedcrafting:flux_star>], 
