...
craftingTable.addShaped("shape_card_quarry_dirt_silk", <item:rftoolsbuilder:shape_card_quarry_silk>, [
    [<item:minecraft:dirt>,<item:cataclysm:flame_eye>,<item:minecraft:dirt>],
...
craftingTable.addShaped("shape_card_quarry_dirt_fortune", <item:rftoolsbuilder:shape_card_quarry_fortune>, [
    [<item:minecraft:dirt>,<item:cataclysm:flame_eye>,<item:minecraft:dirt>],
