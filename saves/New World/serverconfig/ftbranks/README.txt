...
Last README file update: Sat Oct 28 15:24:26 CEST 2023
...
command.arsmagicalegacy
command.arsmagicalegacy.affinity
command.arsmagicalegacy.affinity.add
command.arsmagicalegacy.affinity.add.affinity
command.arsmagicalegacy.affinity.add.affinity.amount
command.arsmagicalegacy.affinity.add.target
command.arsmagicalegacy.affinity.add.target.affinity
command.arsmagicalegacy.affinity.add.target.affinity.amount
command.arsmagicalegacy.affinity.get
command.arsmagicalegacy.affinity.get.affinity
command.arsmagicalegacy.affinity.get.target
command.arsmagicalegacy.affinity.get.target.affinity
command.arsmagicalegacy.affinity.reset
command.arsmagicalegacy.affinity.reset.target
command.arsmagicalegacy.affinity.set
command.arsmagicalegacy.affinity.set.affinity
command.arsmagicalegacy.affinity.set.affinity.amount
command.arsmagicalegacy.affinity.set.target
command.arsmagicalegacy.affinity.set.target.affinity
command.arsmagicalegacy.affinity.set.target.affinity.amount
command.arsmagicalegacy.magic_xp
command.arsmagicalegacy.magic_xp.add
command.arsmagicalegacy.magic_xp.add.amount
command.arsmagicalegacy.magic_xp.add.amount.levels
command.arsmagicalegacy.magic_xp.add.amount.points
command.arsmagicalegacy.magic_xp.add.target
command.arsmagicalegacy.magic_xp.add.target.amount
command.arsmagicalegacy.magic_xp.add.target.amount.levels
command.arsmagicalegacy.magic_xp.add.target.amount.points
command.arsmagicalegacy.magic_xp.get
command.arsmagicalegacy.magic_xp.get.levels
command.arsmagicalegacy.magic_xp.get.points
command.arsmagicalegacy.magic_xp.get.target
command.arsmagicalegacy.magic_xp.get.target.levels
command.arsmagicalegacy.magic_xp.get.target.points
command.arsmagicalegacy.magic_xp.set
command.arsmagicalegacy.magic_xp.set.amount
command.arsmagicalegacy.magic_xp.set.amount.levels
command.arsmagicalegacy.magic_xp.set.amount.points
command.arsmagicalegacy.magic_xp.set.target
command.arsmagicalegacy.magic_xp.set.target.amount
command.arsmagicalegacy.magic_xp.set.target.amount.levels
command.arsmagicalegacy.magic_xp.set.target.amount.points
command.arsmagicalegacy.skill
command.arsmagicalegacy.skill.forget
command.arsmagicalegacy.skill.forget.all
command.arsmagicalegacy.skill.forget.skill
command.arsmagicalegacy.skill.forget.target
command.arsmagicalegacy.skill.forget.target.all
command.arsmagicalegacy.skill.forget.target.skill
command.arsmagicalegacy.skill.learn
command.arsmagicalegacy.skill.learn.all
command.arsmagicalegacy.skill.learn.skill
command.arsmagicalegacy.skill.learn.target
command.arsmagicalegacy.skill.learn.target.all
command.arsmagicalegacy.skill.learn.target.skill
command.arsmagicalegacy.skill.list
command.arsmagicalegacy.skill.list.all
command.arsmagicalegacy.skill.list.known
command.arsmagicalegacy.skill.list.target
command.arsmagicalegacy.skill.list.target.known
command.arsmagicalegacy.skill.list.target.unknown
command.arsmagicalegacy.skill.list.unknown
command.arsmagicalegacy.skill_point
command.arsmagicalegacy.skill_point.add
command.arsmagicalegacy.skill_point.add.skill_point
command.arsmagicalegacy.skill_point.add.skill_point.amount
command.arsmagicalegacy.skill_point.add.target
command.arsmagicalegacy.skill_point.add.target.skill_point
command.arsmagicalegacy.skill_point.add.target.skill_point.amount
command.arsmagicalegacy.skill_point.clear
command.arsmagicalegacy.skill_point.clear.target
command.arsmagicalegacy.skill_point.consume
command.arsmagicalegacy.skill_point.consume.skill_point
command.arsmagicalegacy.skill_point.consume.skill_point.amount
command.arsmagicalegacy.skill_point.consume.target
command.arsmagicalegacy.skill_point.consume.target.skill_point
command.arsmagicalegacy.skill_point.consume.target.skill_point.amount
command.arsmagicalegacy.skill_point.get
command.arsmagicalegacy.skill_point.get.skill_point
command.arsmagicalegacy.skill_point.get.target
command.arsmagicalegacy.skill_point.get.target.skill_point
command.arsmagicalegacy.skill_point.set
command.arsmagicalegacy.skill_point.set.skill_point
command.arsmagicalegacy.skill_point.set.skill_point.amount
command.arsmagicalegacy.skill_point.set.target
command.arsmagicalegacy.skill_point.set.target.skill_point
command.arsmagicalegacy.skill_point.set.target.skill_point.amount
command.attribute
